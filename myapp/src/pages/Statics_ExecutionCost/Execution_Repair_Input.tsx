...
export default function ExecutionRepairInput({
  onClose,
  selectedId,
  subRowId,
  isEditMode = false,
    ...
    >
      ...
      <div className="layout-input-header">
        <div className="header01">
          Thống kê vận hành / Chi phí SCTX thực hiện
        </div>
        <div className="line"></div>
        <div className="header02">
          {isEditMode ? "Chỉnh sửa" : "Tạo mới"} chi phí SCTX thực hiện
        </div>
      </div>
